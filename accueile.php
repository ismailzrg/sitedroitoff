...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  <head>
    ...
    <title>Windmill Acccueile</title>
    <link
    ...
    <script src="./assets/js/Licence 3-lines.js" defer></script>
    <script src="./assets/js/Licence 3-pie.js" defer></script>
  </head>
          ...
          <ul class="mt-6">
            <li class="relative px-6 py-3">
              ...
              <a class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100"
                ...
                alt=""
                aria-hidden="true"/>
                <span class="ml-4">Acccueile</span>
              </a>
            </li>
          </ul>
          <ul>
      ...
      <div class="flex flex-col flex-1 w-full">
        <header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
          <div class="container flex items-center justify-between h-full px-6 mx-auto text-purple-600 dark:text-purple-300">
            ...
            <ul class="flex items-center justify-center content-center flex-row flex-shrink-0 space-x-6">
              <!-- Theme toggler -->
              <li class="flex">
                <button
